...
public class Game3Activity extends AppCompatActivity {
    ...
    RelativeLayout activityGame3, boxGame3, boxTimer;
    ImageView ivTimer;
...
//    boolean timerRunning;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activityGame3 = findViewById(R.id.activityGame3);
        boxGame3 = findViewById(R.id.boxGame3);
    ...
    protected void changeBG(){
        ...
        if(theme == 2){
            activityGame3.setBackgroundResource(R.drawable.background_cover1);
            boxGame3.setBackgroundResource(R.drawable.rectangle_shape2);
            ...
            Num1Image1.setImageResource(R.drawable.char_5_1);
            Num1Image2.setImageResource(R.drawable.char_5_1);
            Num1Image3.setImageResource(R.drawable.char_5_1);
            Num1Image4.setImageResource(R.drawable.char_5_1);
            Num1Image5.setImageResource(R.drawable.char_5_1);
            Num1Image6.setImageResource(R.drawable.char_5_1);
            Num1Image7.setImageResource(R.drawable.char_5_1);
            Num1Image8.setImageResource(R.drawable.char_5_1);
            Num1Image9.setImageResource(R.drawable.char_5_1);
            Num1Image10.setImageResource(R.drawable.char_5_1);

            Num2Image1.setImageResource(R.drawable.char_8_1);
            Num2Image2.setImageResource(R.drawable.char_8_1);
            Num2Image3.setImageResource(R.drawable.char_8_1);
            Num2Image4.setImageResource(R.drawable.char_8_1);
            Num2Image5.setImageResource(R.drawable.char_8_1);
            Num2Image6.setImageResource(R.drawable.char_8_1);
            Num2Image7.setImageResource(R.drawable.char_8_1);
            Num2Image8.setImageResource(R.drawable.char_8_1);
            Num2Image9.setImageResource(R.drawable.char_8_1);
            Num2Image10.setImageResource(R.drawable.char_8_1);

            tvNum1.setTextColor(getResources().getColor(R.color.colorBlueGame3Num1));
            tvNum2.setTextColor(getResources().getColor(R.color.colorBlueGame3Num2));
